<?php  
	...
	if($type == "list"){
		...
		$sql = "SELECT * FROM customer t join group_users g on t.customer_group=g.group_users_id WHERE t.customer_delete_date is null ORDER BY t.customer_id DESC LIMIT " . $offset . "," . $items ."";
		$result = mysql_query($sql,$con);
		$customers = array();
