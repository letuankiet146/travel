function click_load(){
	...
	var url_array2 = full_url.split('&Id=');
	var all_array = url_array[url_array.length-1];
	var id = url_array2[url_array2.length-1];
	var array_compare = "edit-tour&Id=" + id;
	var n = all_array.localeCompare(array_compare);
