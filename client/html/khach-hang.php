    ...
    <div class="box_mid">
        ...
        <div class="mid-content">
			        ...
			        <div class="box-content">
			            <div class="list-diadiem">
			                <ul>
			                	...
			                	<li><a href="model/login.php?thoat">Đăng xuất</a></li>
			                </ul>
			            </div>
			        </div>
			    </div>
            ...
            <div id="vnt-main">
            	...
            	<input type="hidden" id="customerId" value="<?php echo $_SESSION['id']; ?>" />
						        ...
						        <tbody>
						        	<?php 
						        		...
						        		foreach ($list_order as $rows){
											...
											$dateStart=date_create($rows['tour_day_start']);
											$today=date_create(date("Y-m-d"));
											$diff=date_diff($today,$dateStart);
								        	...
								        	echo '	<tr>
								                        ...
								                        <td align="center">
								                            <div class="dropdown">
								                                ...
								                                if((int)$diff > 3){
								                                    echo '<li><a class="" href="index.php?page=lich-su-dat-tour/yeu-cau-huy-don-dat-tour&order_id='.$rows["form_order_id"].'">Hủy đơn đặt tour</a></li>';
								                                }
								                                if($rows["form_order_is_pay"] != 5){
								                                    echo '<li><a href="https://www.nganluong.vn/button_payment.php?receiver=ptthao13@gmail.com&product_name='.$rows["form_order_code"].'&price=2000&return_url=http://iuh-travel.tk/index.php?page=thanh-toan&comments="">Thanh toán</a></li>';
								                                }
								                                echo '</ul>
								                            </div>
								                        </td>
								...
								<div class="form-horizontal mform2">
									...
									<?php
										...
										echo '<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" type="text" name="name" value="'.$rows["customer_name"].'" disabled />
												</div>
												<div class="clear"></div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-6">';
												if($rows["customer_birth"] == ''){
													echo '<input class="form-control" type="text" name="birthday" id="birthday" value="" placeholder="dd/mm/yy" />';
												}
												else{
													echo '<input class="form-control" type="text" name="birthday" value="'.$rows["customer_birth"].'" placeholder="Cập nhật ngày sinh" disabled />';
												}
												echo'
												</div>
												<div class="clear"></div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													...
													if($rows["customer_sex"] == ''){
														...
														echo '<option value="'.$rows["customer_sex"].'">'.$rows["customer_sex"].'</option>';
													}
													echo'
													</select>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" type="text" name="email" id="customerEmailDto" value="'.$rows["customer_email"].'" disabled />
												</div>
												<div class="clear"></div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" type="text" name="phone" id="customerPhoneDto" value="'.$rows["customer_phone"].'" />
												</div>
												<div class="clear"></div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<textarea class="form-control" name="address" id="customerAddressDto">'.$rows["customer_address"].'</textarea>
												</div>
												<div class="clear"></div>
											</div>
					...
					<div class="grid-tour">
						<div class="col-md-10">
							...
							<div class="PasswordBox">
								<div class="form-horizontal mform2">
									<form action="index.php?page=thay-doi-mat-khau/xac-thuc" method="POST" id="changepasss">
										<div class="form-group">
											<label class="col-sm-4 control-label">Mật khẩu cũ:</label>
											<div class="col-sm-6">
												<input class="form-control" type="password" id="oldPassword" name="password" value="" />
											</div>
											<div class="clear"></div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input class="form-control" type="password" id="password_new" name="password_new" value="" />
											</div>
											<div class="clear"></div>
										</div>
										<div class="form-group">
										...
										<div class="form-group mform2btn noneMrbtm">
											<div class="col-sm-offset-4 col-sm-4 pdr5">
												<button type="submit" class="btn btn-block btn-success">Đổi mật khẩu</button>
											</div>
											<div class="col-sm-4 pdl5">
												<a href="index.php?page=khach-hang" class="btn btn-skip">Bỏ qua</a>
											</div>
				...
				<?php if($paged == 'thay-doi-mat-khau/xac-thuc'){ ?>
					...
					<div class="grid-tour">
						<div class="col-md-10">
							...
							<div class="PasswordBox">
								<div class="form-horizontal mform2">
									<form action="index.php?page=thay-doi-mat-khau/thanh-cong" id="xacthuc" method="POST">
										<div class="form-group">
											<div class="col-sm-offset-4 col-sm-7">
												Để xác thực thay đổi mật khẩu, Travel đã gửi mã xác thực tới email 
												<b><?php
					             					foreach (listCustomersOne($_SESSION['id']) as $rows) {
					             						echo $rows['customer_email'];
					             					}
					             					?>
					             				</b>, nhập mã đó vào ô dưới đây để hoàn tất. 
											</div>
											<div class="clear"></div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input class="form-control" type="text" id="verifyCode" name="xacthuc" value="" />
											</div>
											<div class="clear"></div>
										</div>
										<div class="form-group mform2btn noneMrbtm">
				...
				<?php if($paged == 'lich-su-dat-tour/yeu-cau-huy-don-dat-tour'){ ?>
					...
					<div class="grid-tour">
						...
						<div class="col-md-10">
							...
							<div class="RegisterBox">
								<div class="form-horizontal mform2">
									<form action="index.php?page=lich-su-dat-tour/xac-thuc&order_id=<?php echo $rows["form_order_id"]; ?>" method="POST" accept-charset="utf-8">
										<div class="form-group">
				...
				<?php if($paged == 'lich-su-dat-tour/xac-thuc'){ ?>
					...
					<div class="grid-tour">
						...
						<div class="col-md-10">
							...
							<div class="PasswordBox">
								<div class="form-horizontal mform2">
									<form action="index.php?page=lich-su-dat-tour/thanh-cong&order_id=<?php echo $rows["form_order_id"]; ?>" method="POST" accept-charset="utf-8">
										<div class="form-group">
											<div class="col-sm-offset-4 col-sm-7">
