...
<!--===MENU MOBILE==-->
   <nav id="menu">
        <ul>
            <li><a href="index.php?page=trang-chu">Trang chủ</a></li>
            <li><a href="index.php?page=gioi-thieu">Giới thiệu</a></li>
            <li><a href="index.php?page=tour-noi-dia">Tour nội địa</a></li>
            ...
            <?php 
                ...
                if(!isset($_SESSION['name'])){
                    echo '<li><a href="index.php?page=dang-nhap">Đăng nhập</a></li>';
                }
                else{
                    echo '<li><a href="index.php?page=khach-hang">Thông tin tài khoản</a></li>';
                }
            ?>
        </ul>
   </nav> 
