...
<?php if($paged == "khach-hang" || $paged == "cap-nhat-thong-tin" || $paged == "thay-doi-mat-khau" || $paged == "thay-doi-mat-khau/xac-thuc" || $paged == "thay-doi-mat-khau/thanh-cong" || $paged == "lich-su-dat-tour" || $paged == "lich-su-dat-tour/chi-tiet" || $paged == "lich-su-dat-tour/yeu-cau-huy-don-dat-tour" || $paged == "lich-su-dat-tour/xac-thuc" || $paged == "lich-su-dat-tour/thanh-cong"){ ?>
    ...
    <script type="text/javascript" src="js/jquery.validate.js"></script>
    <script type="text/javascript" src="js/product/product.js"></script>
    <script type="text/javascript" src="js/customer/formcheck.js"></script>
<?php } ?>
...
<div id="fb-root"></div>
    <script>(function(d, s, id) {
          ...
          js.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.6&appId=201389723579646";
                      	...
                      	<ul>
                            ...
                            <?php }
                                ...
                                <ul class="customer_menu">
                                    ...
                                    <li><a class="hover_effect_menu" href="model/login.php?thoat"><span class="hover_text">Đăng xuất</span></a></li>
                                </ul>
                            </li>
                            <?php } ?>
                        </ul>
                ...
                <div class="wrapper">
                    <div class="mmenu"><a href="#menu">
                        <?php 
                            ...
                            else if($paged == "chi-tiet-tour"){echo "Chi tiết tour";}
                            else if($paged == "cam-nang-du-lich" || $paged == "chi-tiet-cam-nang"){echo "Cẩm nang du lịch";}
                            else if($paged == "lien-he"){echo "Liên hệ";}
                            else if($paged == "khach-hang"){echo "Khách hàng";}
                            else if($paged == "dat-tour"){echo "Đặt tour";}
                            else if($paged == "ket-qua-tim-kiem"){echo "Kết quả tìm kiếm";}
                        ?>
